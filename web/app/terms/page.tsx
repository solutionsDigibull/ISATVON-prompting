    ...
    <section className="section">
      <div className="container max-w-[760px]">
        ...
        <p className="section-sub !text-left !mx-0 mb-5">
          The ISATVON framework and this website&rsquo;s content are provided by DigiBull AI under
          the{" "}
          <a className="underline" href={`${GITHUB}/blob/main/LICENSE`}>
            Apache 2.0 Licence
          </a>
          , free to use, adapt and share.
        </p>
        <p className="section-sub !text-left !mx-0 mb-5">
          The site, including the Prompt Converter, is provided &ldquo;as is&rdquo; without
          warranties of any kind. AI-generated output can be wrong; review it before relying on it.
          ISATVON improves transparency but does not replace legal, medical, financial, security or
          other professional judgement.
        </p>
